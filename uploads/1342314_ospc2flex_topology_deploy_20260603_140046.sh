...
create_or_reuse instance FlexDFWjumphost os server create --flavor gp.0.8.32 --image 'Ubuntu 24.04' --network tenant-net --security-group default ${KEY_NAME:+--key-name "$KEY_NAME"} FlexDFWjumphost
create_or_reuse instance Windows-Vol-Helper os server create --flavor gp.0.4.16 --image 'Ubuntu 24.04' --network tenant-net --security-group default ${KEY_NAME:+--key-name "$KEY_NAME"} Windows-Vol-Helper
create_or_reuse instance ospc2flex-Alma9-20260428-0625-r3-f2f-DFW3-r3-f2f-1779927070636232216-203261d8-8031b346-794 os server create --flavor gp.0.4.4 --image 'AlmaLinux 9' --network tenant-net --security-group default ${KEY_NAME:+--key-name "$KEY_NAME"} ospc2flex-Alma9-20260428-0625-r3-f2f-DFW3-r3-f2f-1779927070636232216-203261d8-8031b346-794
create_or_reuse instance ospc2flex-debian11new-20260427-1342-r3-f2f-DFW3-r3-f2f-1779927071389806333-6415bd62-56855e4d-845 os server create --flavor gp.0.4.4 --image 'Debian 11' --network tenant-net --security-group default ${KEY_NAME:+--key-name "$KEY_NAME"} ospc2flex-debian11new-20260427-1342-r3-f2f-DFW3-r3-f2f-1779927071389806333-6415bd62-56855e4d-845
create_or_reuse instance ospc2flex-dbian12-20260425-2221 os server create --flavor gp.0.4.4 --image 'Debian 12' --network tenant-net --security-group default ${KEY_NAME:+--key-name "$KEY_NAME"} ospc2flex-dbian12-20260425-2221
create_or_reuse instance ospc2flex-alma8-20260425-2221 os server create --flavor gp.0.4.4 --image 'AlmaLinux 8' --network tenant-net --security-group default ${KEY_NAME:+--key-name "$KEY_NAME"} ospc2flex-alma8-20260425-2221
create_or_reuse instance ospc2flex-rocky8-20260425-2221 os server create --flavor gp.0.4.4 --image 'Rocky Linux 8' --network tenant-net --security-group default ${KEY_NAME:+--key-name "$KEY_NAME"} ospc2flex-rocky8-20260425-2221
create_or_reuse instance ospc2flex-rocky9-20260425-2221 os server create --flavor gp.0.4.4 --image 'Rocky Linux 9' --network tenant-net --security-group default ${KEY_NAME:+--key-name "$KEY_NAME"} ospc2flex-rocky9-20260425-2221
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
log "     openstack floating ip create PUBLICNET | then: openstack server add floating ip Windows-Vol-Helper <FIP>"
log "     openstack floating ip create PUBLICNET | then: openstack server add floating ip ospc2flex-Alma9-20260428-0625-r3-f2f-DFW3-r3-f2f-1779927070636232216-203261d8-8031b346-794 <FIP>"
log "     openstack floating ip create PUBLICNET | then: openstack server add floating ip ospc2flex-debian11new-20260427-1342-r3-f2f-DFW3-r3-f2f-1779927071389806333-6415bd62-56855e4d-845 <FIP>"
log "     openstack floating ip create PUBLICNET | then: openstack server add floating ip ospc2flex-dbian12-20260425-2221 <FIP>"
log "     openstack floating ip create PUBLICNET | then: openstack server add floating ip ospc2flex-alma8-20260425-2221 <FIP>"
log "     openstack floating ip create PUBLICNET | then: openstack server add floating ip ospc2flex-rocky8-20260425-2221 <FIP>"
log "     openstack floating ip create PUBLICNET | then: openstack server add floating ip ospc2flex-rocky9-20260425-2221 <FIP>"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
