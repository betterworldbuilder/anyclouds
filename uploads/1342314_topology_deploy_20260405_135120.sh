...
create_or_reuse volume data-win2019websql2019-1 os volume create --size 75 data-win2019websql2019-1
create_or_reuse volume data-windows-server-2019re-1 os volume create --size 75 data-windows-server-2019re-1
create_or_reuse volume data-u24-frontend-2 os volume create --size 75 data-u24-frontend-2
create_or_reuse volume data-u24-frontend-1 os volume create --size 75 data-u24-frontend-1
create_or_reuse volume data-windows-server-2016-sql-server-2019-1 os volume create --size 50 data-windows-server-2016-sql-server-2019-1
create_or_reuse volume data-u24-postgresl-1 os volume create --size 75 data-u24-postgresl-1
