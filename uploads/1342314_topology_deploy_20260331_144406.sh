...
create_or_reuse instance 'Windows Server 2019Re' os server create --flavor gp.5.2.4 --image 'Windows Server 2019' --network tenant-net --security-group default --password 9Vzmxmxe6cN3O9 'Windows Server 2019Re'
) &
_WIN_PIDS+=($!)
( # Windows VM: win2019websql2019
create_or_reuse instance win2019websql2019 os server create --flavor gp.5.2.4 --image 'Windows Server 2019 with SQL 2019 Web' --network tenant-net --security-group default --password zuTzFmjPElfXrv win2019websql2019
) &
_WIN_PIDS+=($!)
( # Windows VM: Windows Server 2016 + SQL Server 2019
create_or_reuse instance 'Windows Server 2016 + SQL Server 2019' os server create --flavor gp.5.2.4 --image 'Windows Server 2016' --network tenant-net --security-group default --password Ln7AQwFqaxeKe0 'Windows Server 2016 + SQL Server 2019'
) &
_WIN_PIDS+=($!)
