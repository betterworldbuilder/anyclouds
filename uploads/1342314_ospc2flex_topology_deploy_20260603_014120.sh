...
phase_banner "PHASE 5: Load Balancer Creation — no LB pool members defined in topology; skipping → PHASE 6: Volume Attach"
log "ℹ  No LB pool/member edges found in topology — add edges from LB nodes to server nodes to wire members."
