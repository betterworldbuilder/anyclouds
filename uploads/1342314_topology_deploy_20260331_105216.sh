...
create_or_reuse instance 'Windows Server 2019Re' os server create --flavor gp.5.2.2 --image 'Windows Server 2019' --network tenant-net --security-group default --password O2idFqIy3Xy57a 'Windows Server 2019Re'
create_or_reuse instance win2019websql2019 os server create --flavor gp.5.2.2 --image 'Windows Server 2019 with SQL 2019 Web' --network tenant-net --security-group default --password alRGcSTVo8VUpO win2019websql2019
create_or_reuse instance 'Windows Server 2016 + SQL Server 2019' os server create --flavor gp.5.2.2 --image 'Windows Server 2016' --network tenant-net --security-group default --password LTZqkHnMSk4klg 'Windows Server 2016 + SQL Server 2019'
