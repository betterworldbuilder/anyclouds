...
create_or_reuse instance Windows_Server_2019Re-snap-20260416211842-snapwin-safe-ide-img-snapwin-safe-ide-img-r3-f2f-DFW3-to-IAD3-snapwin-final-virtio os server create --flavor gp.5.4.4 --image 'Windows Server 2019' --network tenant-net --security-group default --password x2PmcjKnpzm5rC Windows_Server_2019Re-snap-20260416211842-snapwin-safe-ide-img-snapwin-safe-ide-img-r3-f2f-DFW3-to-IAD3-snapwin-final-virtio
) &
_WIN_PIDS+=($!)
...
create_or_reuse instance opscwin2016-20260509-150218-snap-202605091502-snapwin-virtio-ready-img-snapwin-safe-ide-img-r3-f2f-DFW3-to-IAD3-snapwin-final-virtio os server create --flavor gp.5.4.4 --image 'Windows Server 2016' --network tenant-net --security-group default --password lj2sJCgL26LTHJ opscwin2016-20260509-150218-snap-202605091502-snapwin-virtio-ready-img-snapwin-safe-ide-img-r3-f2f-DFW3-to-IAD3-snapwin-final-virtio
) &
_WIN_PIDS+=($!)
