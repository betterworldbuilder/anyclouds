...
log "Attaching volume u24-postgresl-data-1 → u24-postgresl (max ${MAX_VOL_ATTACH_TRIALS:-3} trials)"
_vol_attach_with_retry u24-postgresl u24-postgresl-data-1 || true
log "Attaching volume u24-frontend-data-1 → u24-FrontEnd (max ${MAX_VOL_ATTACH_TRIALS:-3} trials)"
_vol_attach_with_retry u24-FrontEnd u24-frontend-data-1 || true
log "Attaching volume u24-frontend-data-2 → u24-FrontEnd (max ${MAX_VOL_ATTACH_TRIALS:-3} trials)"
_vol_attach_with_retry u24-FrontEnd u24-frontend-data-2 || true
log "Attaching volume u24backend-data-1 → u24Backend (max ${MAX_VOL_ATTACH_TRIALS:-3} trials)"
_vol_attach_with_retry u24Backend u24backend-data-1 || true
log "Attaching volume windows-server-2019re-data-1 → Windows Server 2019Re (max ${MAX_VOL_ATTACH_TRIALS:-3} trials)"
_vol_attach_with_retry 'Windows Server 2019Re' windows-server-2019re-data-1 || true
log "Attaching volume win2019websql2019-data-1 → win2019websql2019 (max ${MAX_VOL_ATTACH_TRIALS:-3} trials)"
_vol_attach_with_retry win2019websql2019 win2019websql2019-data-1 || true
log "Attaching volume windows-server-2016-sql-server-2019-data-1 → Windows Server 2016 + SQL Server 2019 (max ${MAX_VOL_ATTACH_TRIALS:-3} trials)"
_vol_attach_with_retry 'Windows Server 2016 + SQL Server 2019' windows-server-2016-sql-server-2019-data-1 || true
