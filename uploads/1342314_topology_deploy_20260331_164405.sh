...
ROLLBACK_SCRIPT_PATH="${ROLLBACK_SCRIPT_PATH:-/home/dzoan/OSPC2FLEX/osflex-deployer-2.0/uploads/last_rollback_$(date +%Y%m%d_%H%M%S).sh}"
DEPLOY_ERRORS=0
DEPLOY_SKIPPED=0
DEPLOY_CREATED=0
DEPLOY_TIMEOUTS=0
...
create_or_reuse instance 'Windows Server 2019Re' os server create --flavor gp.5.2.4 --image 'Windows Server 2019' --network tenant-net --security-group default --password T1vaNZsh8L7G3y 'Windows Server 2019Re'
) &
_WIN_PIDS+=($!)
( # Windows VM: win2019websql2019
create_or_reuse instance win2019websql2019 os server create --flavor gp.5.2.4 --image 'Windows Server 2019 with SQL 2019 Web' --network tenant-net --security-group default --password Q8b5opIFweaurc win2019websql2019
) &
_WIN_PIDS+=($!)
( # Windows VM: Windows Server 2016 + SQL Server 2019
create_or_reuse instance 'Windows Server 2016 + SQL Server 2019' os server create --flavor gp.5.2.4 --image 'Windows Server 2016' --network tenant-net --security-group default --password arRjo82tDFSmNN 'Windows Server 2016 + SQL Server 2019'
) &
_WIN_PIDS+=($!)
