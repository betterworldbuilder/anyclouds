...
create_or_reuse instance FlexDFWjumphost os server create --flavor mo.6.4.32 --image 'Ubuntu 24.04' --network tenant-net --security-group default --key-name laptopubuntu24 FlexDFWjumphost
create_or_reuse instance Windows-Vol-Helper os server create --flavor mo.6.2.16 --image 'Ubuntu 24.04' --network tenant-net --security-group default --key-name laptopubuntu24 Windows-Vol-Helper
create_or_reuse instance ospc2flex-dbian12-20260425-2221 os server create --flavor gp.5.4.4 --image ospc2flex-dbian12-20260425-2221 --network tenant-net --security-group default --key-name laptopubuntu24 ospc2flex-dbian12-20260425-2221
create_or_reuse instance ospc2flex-alma8-20260425-2221 os server create --flavor gp.5.4.4 --image ospc2flex-alma8-20260425-2221 --network tenant-net --security-group default --key-name laptopubuntu24 ospc2flex-alma8-20260425-2221
create_or_reuse instance ospc2flex-rocky8-20260425-2221 os server create --flavor gp.5.4.4 --image ospc2flex-rocky8-20260425-2221 --network tenant-net --security-group default --key-name laptopubuntu24 ospc2flex-rocky8-20260425-2221
create_or_reuse instance ospc2flex-rocky9-20260425-2221 os server create --flavor gp.5.4.4 --image ospc2flex-rocky9-20260425-2221 --network tenant-net --security-group default --key-name laptopubuntu24 ospc2flex-rocky9-20260425-2221
create_or_reuse instance SSHED-ospc2flex-rh6-GL-20260425-1356 os server create --flavor gp.5.4.4 --image ospc2flex-rh6-GL-20260425-1356 --network tenant-net --security-group default --key-name laptopubuntu24 SSHED-ospc2flex-rh6-GL-20260425-1356
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
log "     openstack floating ip create PUBLICNET | then: openstack server add floating ip SSHED-ospc2flex-rh6-GL-20260425-1356 <FIP>"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
