...
create_or_reuse instance 'Windows Server 2019Re' os server create --flavor gp.5.2.2 --image 'Windows Server 2019' --network tenant-net --security-group default --password k0ZWzyji35gNu0 'Windows Server 2019Re'
create_or_reuse instance win2019websql2019 os server create --flavor gp.5.2.2 --image 'Windows Server 2019 with SQL 2019 Web' --network tenant-net --security-group default --password 2NhTNSeMR1YOZY win2019websql2019
create_or_reuse instance 'Windows Server 2016 + SQL Server 2019' os server create --flavor gp.5.2.2 --image 'Windows Server 2016' --network tenant-net --security-group default --password xZYTZUlDlWMfnW 'Windows Server 2016 + SQL Server 2019'
