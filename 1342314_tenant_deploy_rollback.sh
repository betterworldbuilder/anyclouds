...
detach_volume_if_needed 'Windows Server 2016 + SQL Server 2019' 'data-windows-server-2016-sql-server-2019-1'
delete_volume 'data-windows-server-2016-sql-server-2019-1'
detach_volume_if_needed 'win2019websql2019' 'data-win2019websql2019-1'
delete_volume 'data-win2019websql2019-1'
detach_volume_if_needed 'Windows Server 2019Re' 'data-windows-server-2019re-1'
delete_volume 'data-windows-server-2019re-1'
detach_volume_if_needed 'u24-FrontEnd' 'data-u24-frontend-2'
delete_volume 'data-u24-frontend-2'
detach_volume_if_needed 'u24-FrontEnd' 'data-u24-frontend-1'
delete_volume 'data-u24-frontend-1'
detach_volume_if_needed 'u24-postgresl' 'data-u24-postgresl-1'
delete_volume 'data-u24-postgresl-1'
