...
def appraisal(component: Dict[str, Any], probes: List[Dict[str, Any]], scan_run_id: str) -> Dict[str, Any]:
    ...
    # A failed source-VM prerequisite skips downstream discovery; it cannot produce a healthy readiness score.
    if ssh_failed:
        readiness = 0; verdict = "BLOCKED_INFRASTRUCTURE"; recommendation = "BLOCKED_INFRASTRUCTURE"; capture = "CLOUD_CHECK_PARTIAL"
