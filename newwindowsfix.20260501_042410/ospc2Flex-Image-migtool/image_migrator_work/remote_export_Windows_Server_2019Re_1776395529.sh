...
repaired_path="$workdir/Windows Server 2019Re-snap-20260417101025-repaired.qcow2"
converted_path="$workdir/Windows Server 2019Re-snap-20260417101025.qcow2"
...
img_path="$workdir/Windows Server 2019Re-snap-20260417101025.img"
...
cleaned=0
SNAP_PREFIX="Windows Server 2019Re-snap-20260417101025"
...
if [ "$HAS_QEMU_IMG" = "YES" ]; then
  ...
  RAW_IMG="$workdir/Windows Server 2019Re-snap-20260417101025.img"
