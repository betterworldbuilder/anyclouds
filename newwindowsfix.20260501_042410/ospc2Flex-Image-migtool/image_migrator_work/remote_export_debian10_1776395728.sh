...
repaired_path="$workdir/debian10-snap-20260417101447-repaired.qcow2"
converted_path="$workdir/debian10-snap-20260417101447.qcow2"
...
img_path="$workdir/debian10-snap-20260417101447.img"
...
cleaned=0
SNAP_PREFIX="debian10-snap-20260417101447"
...
if [ "$HAS_QEMU_IMG" = "YES" ]; then
  ...
  RAW_IMG="$workdir/debian10-snap-20260417101447.img"
...
IMG_ID=$(openstack image create \
  ...
  --format value -c id \
  "ospc2flex-debian10-20260417" 2>&1 || true)
