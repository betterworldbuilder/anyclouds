...
repaired_path="$workdir/centos7-snap-20260417101100-repaired.qcow2"
converted_path="$workdir/centos7-snap-20260417101100.qcow2"
...
img_path="$workdir/centos7-snap-20260417101100.img"
...
cleaned=0
SNAP_PREFIX="centos7-snap-20260417101100"
...
IMG_DOWNLOAD_URL="$OS_IMAGE_URL/v2/images/b514291f-83a4-4980-b4f9-1c7c71d0e091/file"
