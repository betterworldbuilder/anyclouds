...
repaired_path="$workdir/test-dry-vm-snap-20260410131010-repaired.qcow2"
converted_path="$workdir/test-dry-vm-snap-20260410131010.qcow2"
...
img_path="$workdir/test-dry-vm-snap-20260410131010.img"
...
cleaned=0
SNAP_PREFIX="test-dry-vm-snap-20260410131010"
...
RAW_IMG="$workdir/test-dry-vm-snap-20260410131010.img"
...
IMG_ID=$(openstack image create \
  ...
  --format value -c id \
  "test-dry-vm-snap-20260410131010-flex" 2>&1 || true)
