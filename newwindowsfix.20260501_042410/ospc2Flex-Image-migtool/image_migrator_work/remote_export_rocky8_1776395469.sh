...
repaired_path="$workdir/rocky8-snap-20260417101016-repaired.qcow2"
converted_path="$workdir/rocky8-snap-20260417101016.qcow2"
...
img_path="$workdir/rocky8-snap-20260417101016.img"
...
cleaned=0
SNAP_PREFIX="rocky8-snap-20260417101016"
...
if [ "$HAS_QEMU_IMG" = "YES" ]; then
  ...
  RAW_IMG="$workdir/rocky8-snap-20260417101016.img"
...
IMG_ID=$(openstack image create \
  ...
  --format value -c id \
  "ospc2flex-rocky8-20260417" 2>&1 || true)
