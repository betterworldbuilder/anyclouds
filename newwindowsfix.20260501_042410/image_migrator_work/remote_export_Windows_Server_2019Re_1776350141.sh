...
repaired_path="$workdir/Windows Server 2019Re-snap-20260416211842-repaired.qcow2"
converted_path="$workdir/Windows Server 2019Re-snap-20260416211842.qcow2"
...
img_path="$workdir/Windows Server 2019Re-snap-20260416211842.img"
...
cleaned=0
SNAP_PREFIX="Windows Server 2019Re-snap-20260416211842"
...
IMG_DOWNLOAD_URL="$OS_IMAGE_URL/v2/images/67a06650-0f4d-4a54-a188-7231a678a3c1/file"
...
IMG_ID=$(openstack image create \
  ...
  --format value -c id \
  "ospc2flex-win2019-20260416" 2>&1 || true)
