...
repaired_path="$workdir/u24-FrontEnd-snap-20260417000935-repaired.qcow2"
converted_path="$workdir/u24-FrontEnd-snap-20260417000935.qcow2"
...
img_path="$workdir/u24-FrontEnd-snap-20260417000935.img"
...
cleaned=0
SNAP_PREFIX="u24-FrontEnd-snap-20260417000935"
...
if [ "$HAS_QEMU_IMG" = "YES" ]; then
  ...
  RAW_IMG="$workdir/u24-FrontEnd-snap-20260417000935.img"
