...
repaired_path="$workdir/Alma9-snap-20260416223002-repaired.qcow2"
converted_path="$workdir/Alma9-snap-20260416223002.qcow2"
...
img_path="$workdir/Alma9-snap-20260416223002.img"
...
cleaned=0
SNAP_PREFIX="Alma9-snap-20260416223002"
...
if [ "$HAS_QEMU_IMG" = "YES" ]; then
  ...
  RAW_IMG="$workdir/Alma9-snap-20260416223002.img"
