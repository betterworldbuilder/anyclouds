...
repaired_path="$workdir/rocky8-snap-20260416222832-repaired.qcow2"
converted_path="$workdir/rocky8-snap-20260416222832.qcow2"
...
img_path="$workdir/rocky8-snap-20260416222832.img"
...
cleaned=0
SNAP_PREFIX="rocky8-snap-20260416222832"
...
if [ "$HAS_QEMU_IMG" = "YES" ]; then
  ...
  RAW_IMG="$workdir/rocky8-snap-20260416222832.img"
