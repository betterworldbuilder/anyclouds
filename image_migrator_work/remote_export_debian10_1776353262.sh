...
repaired_path="$workdir/debian10-snap-20260416222632-repaired.qcow2"
converted_path="$workdir/debian10-snap-20260416222632.qcow2"
...
img_path="$workdir/debian10-snap-20260416222632.img"
...
cleaned=0
SNAP_PREFIX="debian10-snap-20260416222632"
...
if [ "$HAS_QEMU_IMG" = "YES" ]; then
  ...
  RAW_IMG="$workdir/debian10-snap-20260416222632.img"
...
IMG_ID=$(openstack image create \
  ...
  --format value -c id \
  "ospc2flex-debian10-20260416" 2>&1 || true)
