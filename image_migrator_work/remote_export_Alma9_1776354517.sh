...
repaired_path="$workdir/Alma9-snap-20260416224747-repaired.qcow2"
converted_path="$workdir/Alma9-snap-20260416224747.qcow2"
...
img_path="$workdir/Alma9-snap-20260416224747.img"
...
cleaned=0
SNAP_PREFIX="Alma9-snap-20260416224747"
...
if [ "$HAS_QEMU_IMG" = "YES" ]; then
  ...
  RAW_IMG="$workdir/Alma9-snap-20260416224747.img"
...
IMG_ID=$(openstack image create \
  ...
  --format value -c id \
  "ospc2flex-alma9-20260416" 2>&1 || true)
