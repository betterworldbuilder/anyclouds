...
repaired_path="$workdir/dryrun-verify-vm-snap-20260423100624-repaired.qcow2"
converted_path="$workdir/dryrun-verify-vm-snap-20260423100624.qcow2"
...
img_path="$workdir/dryrun-verify-vm-snap-20260423100624.img"
...
cleaned=0
SNAP_PREFIX="dryrun-verify-vm-snap-20260423100624"
...
IMG_DOWNLOAD_URL="$OS_IMAGE_URL/v2/images/dryrun-verify-vm-snap-20260423100624/file"
...
rm -f "$img_path"
if openstack image save --file "$img_path" "dryrun-verify-vm-snap-20260423100624" 2>/tmp/ospc_img_save_err.txt; then
...
IMG_ID=$(openstack image create \
  ...
  --format value -c id \
  "dryrun-verify-vm-snap-20260423100624-flex" 2>&1 || true)
