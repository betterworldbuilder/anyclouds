...
repaired_path="$workdir/rocky8-snap-20260416224747-repaired.qcow2"
converted_path="$workdir/rocky8-snap-20260416224747.qcow2"
...
img_path="$workdir/rocky8-snap-20260416224747.img"
...
cleaned=0
SNAP_PREFIX="rocky8-snap-20260416224747"
...
if [ "$HAS_QEMU_IMG" = "YES" ]; then
  ...
  RAW_IMG="$workdir/rocky8-snap-20260416224747.img"
...
IMG_ID=$(openstack image create \
  ...
  --format value -c id \
  "ospc2flex-rocky8-20260416" 2>&1 || true)
