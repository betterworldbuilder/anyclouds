...
repaired_path="$workdir/dry-custom-snap-20260410133159-repaired.qcow2"
converted_path="$workdir/dry-custom-snap-20260410133159.qcow2"
...
img_path="$workdir/dry-custom-snap-20260410133159.img"
...
cleaned=0
SNAP_PREFIX="dry-custom-snap-20260410133159"
...
RAW_IMG="$workdir/dry-custom-snap-20260410133159.img"
...
IMG_ID=$(openstack image create \
  ...
  --format value -c id \
  "dry-custom-snap-20260410133159-flex" 2>&1 || true)
