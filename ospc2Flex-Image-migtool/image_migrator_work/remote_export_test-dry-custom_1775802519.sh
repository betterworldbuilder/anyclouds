...
repaired_path="$workdir/test-dry-custom-snap-20260410132839-repaired.qcow2"
converted_path="$workdir/test-dry-custom-snap-20260410132839.qcow2"
...
img_path="$workdir/test-dry-custom-snap-20260410132839.img"
...
cleaned=0
SNAP_PREFIX="test-dry-custom-snap-20260410132839"
...
RAW_IMG="$workdir/test-dry-custom-snap-20260410132839.img"
...
IMG_ID=$(openstack image create \
  ...
  --format value -c id \
  "test-dry-custom-snap-20260410132839-flex" 2>&1 || true)
