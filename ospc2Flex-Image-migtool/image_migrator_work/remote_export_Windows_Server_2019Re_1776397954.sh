...
repaired_path="$workdir/Windows Server 2019Re-snap-20260417103511-repaired.qcow2"
converted_path="$workdir/Windows Server 2019Re-snap-20260417103511.qcow2"
...
img_path="$workdir/Windows Server 2019Re-snap-20260417103511.img"
...
cleaned=0
SNAP_PREFIX="Windows Server 2019Re-snap-20260417103511"
...
IMG_DOWNLOAD_URL="$OS_IMAGE_URL/v2/images/bd541917-bbbf-42ba-89f7-5a6cdd886cca/file"
...
rm -f "$img_path"
if openstack image save --file "$img_path" "bd541917-bbbf-42ba-89f7-5a6cdd886cca" 2>/tmp/ospc_img_save_err.txt; then
...
IMG_ID=$(openstack image create \
  ...
  --format value -c id \
  "ospc2flex-windows2019-20260417" 2>&1 || true)
