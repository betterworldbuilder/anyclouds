...
repaired_path="$workdir/debian10-snap-20260417101025-repaired.qcow2"
converted_path="$workdir/debian10-snap-20260417101025.qcow2"
...
img_path="$workdir/debian10-snap-20260417101025.img"
...
cleaned=0
SNAP_PREFIX="debian10-snap-20260417101025"
...
if [ "$HAS_QEMU_IMG" = "YES" ]; then
  ...
  RAW_IMG="$workdir/debian10-snap-20260417101025.img"
