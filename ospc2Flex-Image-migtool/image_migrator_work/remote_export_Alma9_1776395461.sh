...
repaired_path="$workdir/Alma9-snap-20260417101016-repaired.qcow2"
converted_path="$workdir/Alma9-snap-20260417101016.qcow2"
...
img_path="$workdir/Alma9-snap-20260417101016.img"
...
cleaned=0
SNAP_PREFIX="Alma9-snap-20260417101016"
...
if [ "$HAS_QEMU_IMG" = "YES" ]; then
  ...
  RAW_IMG="$workdir/Alma9-snap-20260417101016.img"
