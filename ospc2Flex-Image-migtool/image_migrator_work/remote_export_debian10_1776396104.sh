...
repaired_path="$workdir/debian10-snap-20260417102144-repaired.qcow2"
converted_path="$workdir/debian10-snap-20260417102144.qcow2"
...
img_path="$workdir/debian10-snap-20260417102144.img"
...
cleaned=0
SNAP_PREFIX="debian10-snap-20260417102144"
...
if [ "$HAS_QEMU_IMG" = "YES" ]; then
  ...
  RAW_IMG="$workdir/debian10-snap-20260417102144.img"
